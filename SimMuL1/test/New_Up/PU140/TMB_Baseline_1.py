...
tmbp.tmbReadoutEarliest2 = cms.bool(True)
tmbp.tmbCrossBxAlgorithm = cms.uint32(0)
tmbp.matchEarliestClctME11Only = cms.bool(True)
tmbp.tmbDropUsedClcts=cms.bool(True)
tmbp.clctToAlct = cms.bool(True)

tmbp.matchTrigWindowSize = cms.uint32(7)
clctp=process.simCscTriggerPrimitiveDigis.clctSLHC
clctp.clctUseCorrectedBx = cms.bool(False)

alctp=process.simCscTriggerPrimitiveDigis.alctSLHC
alctp.alctUseCorrectedBx = cms.bool(False)

clctp.clctMinSeparation = cms.uint32(10)
clctp.clctPidThreshPretrig = cms.uint32(2)
clctp.useDynamicStateMachineZone = cms.bool(False)
clctp.useDeadTimeZoning = cms.bool(False)

alctp.alctPretrigDeadtime = cms.uint32(4)
alctp.alctNarrowMaskForR1 = cms.bool(False)
alctp.alctGhostCancellationSideQuality = cms.bool(False)
alctp.alctGhostCancellationBxDepth = cms.int32(4)
